    ...
    describe "private_body" do
      ...
      context "when private body is set" do
        ...
        it "sets the decrypted private body" do
          expect(extra_fields.decrypted_private_body).to eq('{"en"=>"<xml><dl><dt name=\"something\">Something</dt></dl></xml>"}')
        end
      end
      ...
      context "when saving the private body from the proposal" do
        ...
        it "sets the decrypted private body" do
          expect(proposal.extra_fields.decrypted_private_body).to eq('{"en"=>"<xml><dl><dt name=\"something\">Something</dt></dl></xml>"}')
        end
      end
    end
  end
